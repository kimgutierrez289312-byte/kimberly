(() => {
  const links = [
    ...
    ['Abundancia', 'https://kimberlyali.es/codigo'],
    ['Sabiduría', 'https://kimberlyali.es/blog/slideshows/']
  ];
  const social = [
  ...
  footer.innerHTML = `<div class="ka-footer-brand"><strong>Kimberly Ali</strong><p>Herramientas para transformar tu relación con el dinero y sostener tu expansión.</p><a class="ka-footer-cta" href="https://kimberlyali.es/flujo.html">El dinero fluye hacia mí →</a></div><div class="ka-footer-column"><b>Explora</b>${render(links)}</div><div class="ka-footer-column"><b>Sígueme</b>${renderSocial()}</div>`;
  const isFlujo = /\/flujo(?:\.html)?\/?$/.test(window.location.pathname);
  if (!isFlujo) document.body.prepend(header);
