(() => {
  ...
  if (isFlow || /\/(abundance|codigo)(?:\.html)?\/?$/.test(path)) {
    ...
    `;
    offerStyle.textContent += `body.ka-mindvalley-offer .about-inner{background:#fff!important;border:1px solid #eaded3!important;box-shadow:0 22px 48px rgba(76,38,16,.1)!important}body.ka-mindvalley-offer .about-inner :is(p,h2,h3,span,strong){color:#28170f!important}.ka-mindvalley-offer .about-inner .story-badge{color:#a94418!important}`;
